...
- updated audit binary versions - aligned with rockylinux9-cis-audit
- lint updates
- .secrets updated
- file mode quoted
...
- thanks to @agbrowne
  - [#90](https://github.com/ansible-lockdown/rockylinux9-CIS/issues/90)

- thanks to @mnasiadka
  - [#54](https://github.com/ansible-lockdown/rockylinux9-CIS/pull/54)
...
- [#72](https://github.com/ansible-lockdown/rockylinux9-CIS/issues/72)
...
thanks to @byjunks
[#66](https://github.com/ansible-lockdown/rockylinux9-CIS/issues/66)
...
Control 6_2_16 new variable added thanks to @dulin_gnet on rockylinux8
Will not follow symlink in home directories and amend permissions.

- rockylinux_09_6_2_16_home_follow_symlink: false
...
- typo fixes from rockylinux_08 inheritance
...
### Taken from rockylinux8-CIS issues and PRs
...
- Issues fixed thanks to fgierlinger
  - [#21](https://github.com/ansible-lockdown/rockylinux9-CIS/issues/21)
  - [#22](https://github.com/ansible-lockdown/rockylinux9-CIS/issues/22)
...
- not all controls work with rockylinux8 releases any longer
  - selinux disabled 1.6.1.4
  - logrotate - 4.3.x
- updated to rockylinux8cis v2.0 benchamrk requirements
- removed iptables firewall controls (not valid on rockylinux9)
...
- based on rockylinux8 currently as RH or CIS not GA
